...
class _HomePageState extends State<HomePage> {
    ...
    setState(() {
      ...
      _markers.add(
        Marker(markerId: MarkerId('id-3'),
         ...
         icon: BitmapDescriptor.defaultMarkerWithHue(
           (bToggle) ? BitmapDescriptor.hueGreen : BitmapDescriptor.hueRed
        ), 
         infoWindow: InfoWindow(
           title: 'MovilSV',
      ...
      _markers.add(
        Marker(markerId: MarkerId('id-4'),
         ...
         icon: BitmapDescriptor.defaultMarkerWithHue(
           (bToggle) ? BitmapDescriptor.hueOrange : BitmapDescriptor.hueRed
        ), 
         infoWindow: InfoWindow(
           title: 'MovilSV',
  ...
  final _initialCameraPosition = CameraPosition(target: LatLng(13.701687465625996, -89.22383988311188),zoom: 17);
  @override
